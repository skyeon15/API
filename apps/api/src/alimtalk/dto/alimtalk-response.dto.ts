...
export class GeneralResponseDto<T> {
  @ApiProperty({ description: '트랜잭션 고유 ID', example: 'PAT-260401-A7B8C9' })
  tid: string;
...
export class SendResultDataDto {
  @ApiProperty({ description: '메시지 ID', example: 123 })
  messageId: number;
  ...
  @ApiProperty({ description: '예약된 시각', example: '2026-04-01T15:00:00.000Z', required: false })
  scheduledAt?: Date | null;

  @ApiProperty({ description: '발송 시각', example: '2026-04-01T06:28:11.000Z', required: false })
  sentAt?: Date | null;
}
...
export class ResultCheckDataDto {
  ...
  @ApiProperty({ description: '결과 확인 시각', example: '2026-04-02T10:00:00.000Z' })
  checkedAt: Date | null;

  @ApiProperty({ description: '수신자 전화번호', example: '01012345678' })
  receiverPhone: string;

  @ApiProperty({ description: '발송 시각', example: '2026-04-01T06:28:11.000Z' })
  sentAt: Date | null;
}
