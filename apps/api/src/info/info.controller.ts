...
export class InfoController {
  ...
  @ApiResponse({
    ...
    content: {
      ...
      'text/plain': {
        example:
          '[ 서울의 현재 날씨는 맑음! ][br]조회시각 : 2026-03-26 07:31:05[br][br]기온 : 15.2 (최저 10.1/최고 20.5)[br]바람 : 남서풍 2.1m/s[br]강수확률 : 0%[br]습도 : 35%[br]일몰시간 : 18:45[br]',
      },
    },
  })
  async getWeather(
  ...
  @ApiOperation({
    summary: '올림픽 메달 순위',
    description:
      '올림픽 경기가 한창인가요? 지금 바로 국가별 메달 획득 순위를 확인해 보세요!',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiResponse({
    ...
    content: {
      'application/json': {
        schema: {
          ...
          properties: {
            datetime: {
              type: 'string',
              description: '데이터 갱신 시각 (YYYY-MM-DD hh:mm:ss)',
            },
            confirmed: {
              type: 'array',
              items: { type: 'number' },
      ...
      'text/plain': {
        example:
          '[ 국내 코로나 현황 ][br]조회시각 : 2026-03-26 07:31:04[br][br]직전 발표자료[br]누적 확진자 : 34,436,586(+1,500)[br]위중증 : 179(+0)[br]사망자 : 35,812(+0)[br]',
      },
    },
  })
